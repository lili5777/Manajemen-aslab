$(document).ready(function () {
    $("#basic-alert").on("click", function () {
        ...
        $(".confirm-text").on("click", function () {
            // Ambil ID atau URL dari tombol yang diklik
            const url = $(this).data("url"); // Pastikan tombol memiliki atribut data-url
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: url,
                        type: "DELETE", // Sesuaikan dengan metode HTTP di route Anda
                        headers: {
                        ...
                        success: function (response) {
                            Swal.fire({
                                ...
                                // Reload halaman atau hapus elemen dari DOM
                                location.reload();
                            });
                        },
                        error: function (xhr) {
