...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <h1 class="sitename">LABORATORY ASSISTANT</h1>
            </a>
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="{{ asset('home/assets/img/hero-bg-2.jpg') }}" alt="" class="hero-bg">

            <div class="container">
                <div class="row gy-4 justify-content-between">
                    <div class="col-lg-4 order-lg-last hero-img" data-aos="zoom-out" data-aos-delay="100">
                        <img src="{{ asset('home/assets/img/undipaa.png') }}" class="img-fluid animated" alt="">
                    </div>

                    <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
                        <h1>Organize, Manage, and Certify <span>Easily</span></h1>
                        <p>Streamline lab tasks with seamless organization and certification tools</p>
                        <div class="d-flex">
                ...
                <div class="row align-items-xl-center gy-5">
                    ...
                    <div class="col-xl-5 content">
                        ...
                        <p>Ipsa sint sit. Quis ducimus tempore dolores impedit et dolor cumque alias maxime. Enim
                            reiciendis minus
                            et rerum hic non. Dicta quas cum quia maiores iure. Quidem nulla qui assumenda incidunt
                            voluptatem tempora
                            deleniti soluta.</p>
            ...
            <div class="container">
                ...
                <div class="row gy-4 align-items-center features-item">
                    <div class="col-md-5 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="100">
                        <img src="{{ asset('home/assets/img/details-1.png') }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row gy-4 align-items-center features-item">
                    <div class="col-md-5 order-1 order-md-2 d-flex align-items-center" data-aos="zoom-out"
                        data-aos-delay="200">
                        <img src="{{ asset('home/assets/img/details-2.png') }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row gy-4 align-items-center features-item">
                    <div class="col-md-5 d-flex align-items-center" data-aos="zoom-out">
                        <img src="{{ asset('home/assets/img/details-3.png') }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row gy-4 align-items-center features-item">
                    <div class="col-md-5 order-1 order-md-2 d-flex align-items-center" data-aos="zoom-out">
                        <img src="{{ asset('home/assets/img/details-4.png') }}" class="img-fluid" alt="">
                    </div>
