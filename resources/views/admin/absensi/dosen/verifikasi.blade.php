                                ...
                                <tbody>
                                    @foreach($absensi as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{$asdos->where('id',$item->id_asdos)->first()->nama}}</td>
                                            ...
                                            <td>
                                                @if ($item->verifikasi == 'pending')
                                                    <a href="{{route('terima_absensi',$item->id)}}" ><span class="badge bg-success">Terima</span></a>
                                                    <a href="" ><span class="badge bg-danger">Tolak</span></a>
                                                @elseif($item->verifikasi == 'terima')
                                                    <span class="badge bg-warning text-dark">Terima</span>
                                                @else
                                ...
                                <div class="card stat-card bg-success bg-opacity-10 border-success">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted mb-0">
                                            {{ $summary['total'] > 0 ? number_format(($summary['hadir'] / $summary['total']) * 100, 1) : 0 }}%
                                            dari total
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="card stat-card bg-warning bg-opacity-10 border-warning">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted mb-0">
                                            {{ $summary['total'] > 0 ? number_format(($summary['izin'] / $summary['total']) * 100, 1) : 0 }}%
                                            dari total
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="card stat-card bg-danger bg-opacity-10 border-danger">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted mb-0">
                                            {{ $summary['total'] > 0 ? number_format(($summary['alpa'] / $summary['total']) * 100, 1) : 0 }}%
                                            dari total
                                        </p>
                                    </div>
                                </div>
