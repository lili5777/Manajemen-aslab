                        ...
                        <table class="table datatable ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a class="product-img" href="productlist.html">
                                            <img src="{{ asset('img/product/product2.jpg') }}" alt="product">
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a class="product-img" href="productlist.html">
                                            <img src="{{ asset('img/product/product3.jpg') }}" alt="product">
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a class="product-img" href="productlist.html">
                                            <img src="{{ asset('img/product/product4.jpg') }}" alt="product">
                                        </a>
